            ...
            <div className="w-60 border-r fixed h-full overflow-y-auto">
                ...
                <div className="border-t mt-4 pt-4 px-2">
                    ...
                    {Array.from({ length:5 }).map((_, index) => (
                        <div key={index} className="flex items-center p-2 hoveer:bg-gray-100 rounded-md">
                            <div className="h-8 w-8 rounded-full bg-gray-300 mr-2"></div>
                            <div>
                                <p className="text-sm font-semi-bold">user_{index + 1}</p>
                ...
                <div className="px-3 py-4 mt-2">
                    <p className="text-sm text-gray-500 mb-4">
                        Log in to follow creaters, like videos, and view comments.
                    </p>
                    <Link href="/login">
            ...
            <div className="ml-60 flex-1">
                <div className="max-w-[1150px] mx-auto">
                    ...
                    <header className="h-16 border-b flex items-center justify-between px-4">
                        ...
                        <div className="w-1/3 dlex justify-end space-x-4">
                            <Link href="/upload">
