        ...
        <div className="flex py-4 border-b">
            ...
            <div className="flex-1">
                ...
                <div className="flex items-center text-sm mb-3">
                    ...
                    <span className="font-medium max-w-[536px]">{audio}</span>
                </div>

                <div className="flex">
                    {/* Video container */}
                    <div className="mr-5 w-[386px] h-[536px] bg-black rounded-md flex items-center justify-center relative overflow-hidden">
                        <p className="text-white">Video Placeholder</p>
                        <div className="absolute bottom-4 left-4 text-white text-sm">
                            <p className="mb-1">8:38</p>
                        </div>
                    </div>
